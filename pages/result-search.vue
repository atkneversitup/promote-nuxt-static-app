                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item open">
                    ...
                    <ul class="nav-main-submenu">
                      ...
                      <li class="nav-main-item">
                        <a class="nav-main-link active" href="be_pages_ecom_store_search.html">
                  ...
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">Video UI Kit</a>
                      </div>
                  ...
                  <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                      <div class="mb-1">
                        ...
                        <a class="h6" href="be_pages_ecom_store_product.html">Todo App</a>
                      </div>
  ...
  head () {
    return {
      ...
      link: [
        ...
        { rel: 'stylesheet', href: '/css/oneui.min.css' }
      ],
      script: [
        // ... other script tags
        { src: '/js/lib/jquery.min.js' },
        { src: '/js/plugins/jquery-validation/jquery.validate.min.js' },
        { src: '/js/oneui.app.min.js' }
